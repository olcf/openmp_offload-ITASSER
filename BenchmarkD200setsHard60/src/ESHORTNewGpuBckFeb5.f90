...
!$acc& copy(eshort2,eshort3,eshort10)
! !$acc&  copy(ESHORT2,ESHORT3,ESHORT10,ESHORT4,
! !$acc&  ESHORT4a,ESHORT5b,ESHORT5a,ESHORT6,
! !$acc&  ESHORT7,ESHORT8,ESHORT9,ESHORT11,ESHORT12)
...
!$acc kernels loop gang(3) worker(10) default(present) async(2)
! !$acc& reduction(+:ESHORT2,ESHORT3,ESHORT10,ESHORT4,ESHORT5)
...
ccc   'svmseqSG678.dat':
!$acc loop vector ! reduction(+:ESHORT23)  !it was vector/ change 2
