...
! !$OMP target teams distribute parallel do num_teams(100) nowait  !!this is the 
! !$OMP target teams distribute 
      !!!!!!!!!! Correct Data Map 
!$OMP target data map(to: sec,jbin,seq,x,z,y,hbz,ez,gx,gy,gz, !enter data
...
! !$acc&                        EHB5,EHB5a,EHB5b,ICNT1,SUMCT1)
! !$OMP target 
!$OMP  target teams distribute parallel do simd nowait ! private(i) !reduction(+: EHB1)
