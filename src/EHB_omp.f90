...
*****************************************************************
! !$omp target data map(to: ehb4,ehb5a,ehb5b,ehb3,ehb2,
! !$omp&              ehb1c,ehb1b,ehb1a,ehb1,SUMCT1,ICNT1)
! !$acc parallel loop gang default (present) async(1) ! reduction(+:EHB1,EHB1a,EHB1b,EHB1c,EHB2,EHB3,EHB4,
!$omp target teams distribute !map (to: ehb4,ehb5a,ehb5b,ehb3,ehb2,
! !$omp&              ehb1c,ehb1b,ehb1a,ehb1,SUMCT1,ICNT1) !parallel do simd !defaultmap(present:aggregate)&
...
********************** start i-cicle ****************************
*****************************************************************
! !$acc loop private(i,fact,axki,ayki,azki,dist,bxi,byi,bzi,
! !$acc&          axi,ayi,azi,idist)
!!! !$acc&   reduction(+:ICNT1,SUMCT1,EHB4,EHB1a)
!$omp parallel do private(i,fact,axki,ayki,azki,dist,bxi,byi,bzi,
...
! Code was translated using: /lustre/orion/stf016/scratch/maccarthy/gpfs-data/maccarthy/sw/ACC-OMP-migration/intel-application-migration-tool-for-openacc-to-openmp/src/intel-application-migration-tool-for-openacc-to-openmp EHB.f90
