...
! Code was translated using: /lustre/orion/stf016/scratch/maccarthy/gpfs-data/maccarthy/sw/ACC-OMP-migration/intel-application-migration-tool-for-openacc-to-openmp/src/intel-application-migration-tool-for-openacc-to-openmp move6.f90
