...
c     backup old path----------->
      ...
      enddo
c     prepare new path------------->
!cc!$acc data present(nop(:),nom(:),noa(:),noaa(:),nomm(:),
!cc!$acc&              nopp(:),envir(:,:,:,:,:))
! !$acc kernels
      do i=mm,Lch
...
! Code was translated using: /lustre/orion/stf016/scratch/maccarthy/gpfs-data/maccarthy/sw/ACC-OMP-migration/intel-application-migration-tool-for-openacc-to-openmp/src/intel-application-migration-tool-for-openacc-to-openmp move_c_end.f90
