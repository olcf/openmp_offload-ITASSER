...
!!$OMP target enter data map(to:ezrep,icarep,mv,xrep,zrep,yrep,etzrep,exrep,
!!$OMP& eyrep,eczrep,egxrep,egyrep,ebzrep,ecxrep,ecyrep,ebxrep,ebyrep,egzrep,
!!$OMP& etxrep,etyrep)
...
!!$OMP& map(tofrom:ezrep,icarep,mv,xrep,zrep,yrep,etzrep,exrep,
!!$OMP& eyrep,eczrep,egxrep,egyrep,ebzrep,ecxrep,ecyrep,ebxrep,ebyrep,egzrep,
!!$OMP& etxrep,etyrep)
...
c^^^^^^^^^^^^^^^^^ swap_RS finished ^^^^^^^^^^^^^^^^^^^^^^^^^^^^
!$acc end data     
!!$OMP target exit data map(from: ezrep,icarep,mv,xrep,zrep,yrep,etzrep,exrep,
!!$OMP& eyrep,eczrep,egxrep,egyrep,ebzrep,ecxrep,ecyrep,ebxrep,ebyrep,egzrep,
!!$OMP& etxrep,etyrep) 
      return
      end
