...
!$OMP& map(to: ey,ex,ez,egx,egy,egz,eby,ebz,etx,ety,etz,ecx,ecy,ecz)
!$OMP& map(from: ex_o,ey_o,ez_o,ety_o,egx_o,egy_o,egz_o,ebx_o,eby_o,ebz_o,
!$OMP& ecy,ecx_o,ecz_o,etx_o,ety_o,etz_o)
...
!$OMP& map(from:ex_n,ey_n,ez_n,ecx_n,ecy_n,ecz_n,egx_n,egy_n,egz_n,
!$OMP& etx_n,ety_n,etz_n)    
!// !$acc kernels
      do i=m2,Lch
